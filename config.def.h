...
#define PATH(name)                      "/home/ch/.config/dwmblocks/scripts/" name
...
/*      pathu                           pathc                           interval        signal */
        /* { PATH("cpu_usage"),    NULL,               10,   1}, */
        /* { PATH("memory"),       NULL,               30,   1}, */
        /* { PATH("disk"),         NULL,               30,   1}, */
        /* { PATH("battery"),      NULL,               10,   1}, */
        /* { PATH("volume"),       PATH("volume"),     1,    1}, */
        /* { PATH("keyindicator"), NULL,               0,    11}, */
        /* { PATH("aur_update"),   PATH("aur_update"), 3600, 1}, */
        /* { PATH("wifi"),         NULL,               10,   1}, */
        { PATH("date"),         NULL,               1,    1},
